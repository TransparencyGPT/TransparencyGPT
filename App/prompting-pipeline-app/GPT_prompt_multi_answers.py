...
def web_analysis(author, url, topics, devMode):
    ...
    if (devMode):
        return "Development mode is on to prevent using up GPT tokens. Set devMode=False to access analysis", 0
    ...
    return final_answer, website_info, subsidiary_info, author_info, audience_info, total_token_count
