...
def extract_transparency(title, article, author, url):
    ...
    return subjectivity_score, text_analysis, GPT_answer, GPT_token_count
...
#subjectivity_score, final_answer, GPT_token_count = extract_transparency(title, article, author, url)
# Check output
